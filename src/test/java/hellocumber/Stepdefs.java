...
public void check_elementshomepage(){
...
@And("And I hit the search button")
public void hit_search_button(){
	//Click search button overlay blocking
...
@And("And Browser2 closes")
public void close_browser2(){
	driver2.close();
	throw new io.cucumber.java.PendingException();
}

@And("And Browser3 opens")
public void open_browser3(){
		System.setProperty("webdriver.chrome.driver", "C:\\JavaProjects\\Testing\\AdpTestDH\\NewChromedriver\\chromedriver.exe");
...
@And("And I validate all are BMWs")
